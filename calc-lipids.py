...
def lipid_abstractor(grofile,trajfile,**kwargs):
	...
	# ...!!! HARDCODED METADATA from yaml file
	selector = {
		'resnames':['DOPC','DOPS','PIP2','POP2','POPC','DOPE'],
		'type':'com'}
	separator = {'cluster':False,'lipid_tip':'name PO4'}
	nojumps = ''
	...
	result['resnames'] = np.array(sel.residues.resnames).astype(str)
...
if __name__ == '__main__':
	...
	result,attrs = lipid_abstractor(grofile=gro_fn,trajfile=xtc_fn)
